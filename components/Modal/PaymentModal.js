...
const PaymentModal = ({ cartItems }) => {
  ...
  const totalPrice = cartItems.reduce(
    (acc, curr) => acc + curr.price * curr.price,
    0
  );
    ...
    <div className="mx-auto flex items-center justify-center z-[100]">
      ...
      >
        <div
          ...
          className={`absolute overflow-x-hidden overflow-y-scroll w-full h-full flex justify-center  drop-shadow-2xl rounded-lg ${
            openModal
        ...
        >
          <main>
            <div class="font-[sans-serif] bg-gray-50 z-[100]">
              <div class="grid lg:grid-cols-2 gap-4 h-full">
                  ...
                  <div class="relative h-full">
                    <div class="p-8 lg:overflow-auto lg:h-[calc(100vh-60px)]">
                      ...
                      {cartItems.map((cardData) => (
                        <div key={cardData._id} class="space-y-6 mt-10">
                          <div class="grid sm:grid-cols-2 items-start gap-6">
                            ...
                            <div className="mt-4">
                              ...
                              <ul class="text-white space-y-3 mt-4">
                                ...
                                <li class="flex flex-wrap gap-4">
                                  Total Price{" "}
                                  <span class="ml-auto">
                                    {cardData?.quantity * cardData?.price}
                                  </span>
                                </li>
                              </ul>
                            </div>
                ...
                <div class="h-max rounded-md p-8 sticky top-0">
                  <h2 class="text-2xl font-bold text-[#333]">
                    Complete your order
                  </h2>
                  <form class="mt-10">
                    <div>
